...
public final class FragmentDatosMedicosBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentDatosMedicosBinding(@NonNull FrameLayout rootView,
  ...
  @NonNull
  public static FragmentDatosMedicosBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentDatosMedicosBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_datos_medicos, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentDatosMedicosBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDatosMedicosBinding((FrameLayout) rootView, btnDatoPacienteGuardar,
