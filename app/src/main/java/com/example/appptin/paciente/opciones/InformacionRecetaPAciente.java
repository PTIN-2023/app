...
public class InformacionRecetaPAciente {
    private int cont;
    ...
    public InformacionRecetaPAciente(){};

    public InformacionRecetaPAciente(String duration, String lastUsed, JSONArray medicineList, String notes, String prescriptionIdentifier, String renewal,int cont) {
