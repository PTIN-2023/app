 ...
 * Use the {@link FiltreGestorFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FiltreGestorFragment extends Fragment {
    ...
    public static FiltreGestorFragment newInstance(String param1, String param2) {
        FiltreGestorFragment fragment = new FiltreGestorFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_filtre_gestor, container, false);
        ...
        closeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fragmentTransaction.replace(R.id.frame_container, new InventarioGestorFragment());
        ...
        buttonApply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                InventarioGestorFragment fragment = new InventarioGestorFragment();
